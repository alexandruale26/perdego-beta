  ...
  return (
    <div className="h-9 w-full relative">
      <input
        ...
        className={twMerge(
          `w-full h-full rounded-md border border-stone-300 bg-white pl-3 pr-9 text-sm font-light transition-colors placeholder:text-stone-500 placeholder:font-light focus-visible:outline-none focus-visible:border-2 focus-visible:border-stone-700 disabled:bg-stone-100 disabled:cursor-not-allowed placeholder:select-none`,
          className
        )}
        ref={ref}
        {...props}
