  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "primary-950": colors.emerald[950],

        "grey-50": colors.zinc[50],
        "grey-100": colors.zinc[100],
        "grey-200": colors.zinc[200],
        "grey-300": colors.zinc[300],
        "grey-400": colors.zinc[400],
        "grey-500": colors.zinc[500],
        "grey-600": colors.zinc[600],
        "grey-700": colors.zinc[700],
        "grey-800": colors.zinc[800],
        "grey-900": colors.zinc[900],
        "grey-950": colors.zinc[950],
      },
      boxShadow: {
